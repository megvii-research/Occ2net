...
# 0. build global feature backbone
_CN.LOFTR.USING_RAY = False
_CN.LOFTR.GLOBAL_STEP = ["res4", "res5", "res6"]
_CN.LOFTR.ROTATE_FEATURE = False
_CN.LOFTR.SPVS_MASK = "loop_back"  # options: ["loop_back", "valid", "nonocc"]
...
_CN.LOFTR.MATCH_COARSE.PATCH_CENTER = False
