...
cfg.DATASET.TRAIN_DATA_ROOT = "datasets/data/scannet/trainval"
cfg.DATASET.TRAIN_NPZ_ROOT = "datasets/data/scannet/index/scene_data/train"
cfg.DATASET.TRAIN_LIST_PATH = "datasets/data/scannet/index/scene_data/train_list/scannet_all.txt"
cfg.DATASET.TRAIN_INTRINSIC_PATH = "datasets/data/scannet/index/intrinsics_trainval.npz"

TEST_BASE_PATH = "assets/scannet_test_1500"
cfg.DATASET.TEST_DATA_SOURCE = "ScanNet"
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "datasets/data/scannet/test"
